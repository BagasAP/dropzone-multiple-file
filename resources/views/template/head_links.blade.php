  ...
  <!-- Material Design -->
  <link rel="stylesheet" href="{{asset('template/dist/css/bootstrap-material-design.min.css') }}">
  <link rel="stylesheet" href="{{asset('template/dist/css/ripples.min.css') }}">
  <link rel="stylesheet" href="{{asset('template/dist/css/MaterialAdminLTE.min.css') }}">
  <!-- AdminLTE Skins. Choose a skin from the css/skins
       folder instead of downloading all of them to reduce the load. -->
  <link rel="stylesheet" href="{{asset('template/dist/css/skins/all-md-skins.min.css') }}">
  <!-- Morris chart -->
